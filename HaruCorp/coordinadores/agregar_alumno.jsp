        ...
        <div class="container" id="main-container">
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-file-o"></i> Agregar alumno a la actividad:
                            <%
                ...
                <div>
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-bars"></i> Agregar alumno</h3>
                                <div class="box-tool">
                            ...
                            <div class="box-content">
                               <form action='/agregaA' class='form-horizontal' id='validation-form' method='post'>

                                    <div class="form-group">

                                        <label class="col-sm-3 col-lg-2 control-label" for="username">N&uacute;mero de boleta:</label>
                                        <div class="col-sm-6 col-lg-4 controls">
                                            <input type="text" name="boleta" id="boleta" class="form-control" data-rule-required="true" data-rule-minlength="3" />
                                        </div>
                                    </div>
                                    <%
                                    out.println("<input type='hidden' value='"+idax+"' name='id_actividad'/>");
                                    
                                    session.setAttribute("id_coordinador",id_coordinador);
                                    session.setAttribute("id_actividad",idax);
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                                            ...
                                            <% 
                                            out.println("<a href='index.jsp?id_coordinador="+id+"'><button type='button' class='btn'>Cancelar</button></a>");%>
