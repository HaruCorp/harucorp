        ...
        <div class="container" id="main-container">
            ...
            <div id="sidebar" class="navbar-collapse collapse">
                ...
                <ul class="nav nav-list">
                    ...
                    <li>
                        <a href="form_alumno.html" class="dropdown-toggle">
                            <i class="fa fa-edit"></i>
                            <span>Alta de alumnos</span>
                        </a>
                        <!-- END Submenu -->
                    </li>

                    <li>
                        <a href="lista_alumnos.php" class="dropdown-toggle">
                    ...
                    <li>
                        <a href="form_actividad.html" class="dropdown-toggle">
                            <i class="fa fa-edit"></i>
                            <span>Alta de actividades</span>
                        </a>
                        <!-- END Submenu -->
                    </li>

                    <li>
                        <a href="lista_actividades.php" class="dropdown-toggle">
                            <i class="fa fa-list"></i>
